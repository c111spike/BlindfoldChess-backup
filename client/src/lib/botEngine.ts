...
const DIFFICULTY_CONFIG: Record<BotDifficulty, DifficultyConfig> = {
  ...
  club: { elo: 1200, timePerMoveMs: 2000, maxDepth: 5, multiPvCount: 4, stockfishNodes: 200000, mistakeProbability: 0.05, useStockfish: true },
  advanced: { elo: 1500, timePerMoveMs: 2500, maxDepth: 6, multiPvCount: 3, stockfishNodes: 500000, mistakeProbability: 0.03, useStockfish: true },
